...
var app = {
    ...
    function onDeviceReady(){
		...
		*/
		...
		window.StarIOAdapter.printepson=function(message,port_search,port_dir,success_callback, error_callback){
			//alert("todas buscar");
			if(error_callback == null) {
				error_callback = handle_error_callback;
			}
			return cordova.exec(success_callback, error_callback, "StarIOAdapter", "printepson", [message,port_search,port_dir]);
		};
